...
#  for each transaction, split the string around whatever character you replaced  ;,; with
...
for people in transactions_clean:
    customers.append(people[0])
...
for totals in sales:
    total_sales += float(totals.strip('$'))
...
#  using the string method .format() and the function color_count(),
#  iterate through the list colors and print a sentence that says how many threads of each color were sold today

colors = ['red', 'yellow', 'green', 'white', 'black', 'blue', 'purple']
for color in colors:
    print("Thread Shed sold {0} spools of {1} thread today".format(color_count(color),
                                                                  color))
