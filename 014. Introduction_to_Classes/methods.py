...
# Below we created a Dog class with a .time_explanation() method that takes one argument, self, which refers to the object calling the function.
...
# but were able to refer to self in the function body.
