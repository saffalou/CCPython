...
# as cards are drawn, remove them from the deck
#  store them against key of past, present future in a dictionary called spread
...
# print out the past, present and future details
